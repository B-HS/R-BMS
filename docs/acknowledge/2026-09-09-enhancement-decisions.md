...
> **역사 합의와 현재 상태(2026-09-16):** 결정 1~7·9~12와 Phase B~H는 구현 완료입니다. 결정 8의 당시 수동 Git 운용은 현재 작업 규칙에 대체됐습니다. 릴리스는 dev-only로 남아 있으며 Phase R에서 사용자 보관 키와 함께 수행합니다. 현재 정본은 [roadmap](../roadmap.md)과 [PROCESS](../PROCESS.md)입니다.
