...
> **역사 설계(2026-09-09)** — Phase G 구현은 완료했습니다. 아래 본문의 착수 조건·TODO·라인 앵커는 당시 기록으로 보존합니다. 현재 정본은 [roadmap](../roadmap.md), 근거는 [PROCESS](../PROCESS.md)와 [Phase G 이력](../history/2026-09-16-phase-g-data-long-tail.md)입니다.
