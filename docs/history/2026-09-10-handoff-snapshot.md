# HANDOFF 스냅샷 보존 (2026-09-10 세션, 2026-09-16 주석 포함)

> 2026-09-18 핸드오프 준비에서 `docs/HANDOFF.md`를 현재 세션 스냅샷으로 덮어쓰면서, 종전 본문을 그대로 여기로 옮겼다. 아래 내용은 2026-09-10 당시 사실이며 현재 지시로 사용하지 않는다. 현재 진입점은 `docs/HANDOFF.md`와 `docs/PROCESS.md`다.
...
>
> 현재 상태가 필요하면 이 문서의 본문을 갱신하지 말고 [PROCESS.md](../PROCESS.md), [README.md](../README.md), [ci-release.md](../ci-release.md), [history/2026-09-16-phase-g-data-long-tail.md](2026-09-16-phase-g-data-long-tail.md), [history/2026-09-16-phase-h-minor-followups.md](2026-09-16-phase-h-minor-followups.md)를 확인합니다.
