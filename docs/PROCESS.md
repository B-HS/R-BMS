...
- [x] C 구조 개편(2026-09-09, 명세 `docs/plan/2026-09-09-phase-c-spec.md`) — Stage enum·PlaySession→rbms-play·rbms-config·설정 descriptor 테이블·판정/게이지 데이터화·rbms-store/rbms-library 이관·CI lint 게이트/thiserror/forbid(unsafe)
